// app/api/generate/route.ts — javari-manufacturing
...
const CREDIT_COST      = 8
const SYSTEM           = `You are a manufacturing efficiency expert. Help manufacturers optimize production, reduce waste, improve quality, and implement lean/Six Sigma principles.`
const ACTIONS          = ["production_plan", "quality_control", "lean_analysis", "cost_reduction", "process_improvement", "supplier_evaluation"]
